...
SLOT="0"
KEYWORDS="~amd64"
IUSE="X doc crypt argon2 avif bmp -flif heif jpeg2k jpegls jxl -jxr +png tiff webp brotli bzip2 lzma zlib zstd"
...
REQUIRED_USE="|| ( avif bmp flif heif jpegls jpeg2k jxl jxr png tiff webp )
	argon2? ( crypt )"
S="${WORKDIR}/${MyP}"
