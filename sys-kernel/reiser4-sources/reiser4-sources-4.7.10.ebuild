...
REISER4_URI="http://downloads.sourceforge.net/project/reiser4/reiser4-for-linux-4.x/reiser4-for-${KV_MAJOR}.${KV_MINOR}.0.patch.gz"
...
UNIPATCH_LIST="${UNIPATCH_LIST} ../reiser4-for-${KV_MAJOR}.${KV_MINOR}.0.patch"

src_unpack() {
	unpack reiser4-for-${KV_MAJOR}.${KV_MINOR}.0.patch.gz
	kernel-2_src_unpack
}
