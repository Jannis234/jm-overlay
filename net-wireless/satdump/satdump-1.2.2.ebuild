...
SATDUMP_PLUGINS="aim airspy_sdr analog aws bladerf_sdr bluewalker3 bochum cluster cubesat dmsp dscovr dvb elektro_arktika eos fy2 fy3 fy4 gcom geonetcast gk2a goes gvar_extended hackrf_sdr himawari hinode inmarsat jason3 jpss landsat limesdr_sdr mats meteor meteosat mirisdr_sdr net_source_sdr noaa_metop oceansat orbcomm others plutosdr_sdr portaudio_sink proba remote_sdr rfnm_sdr rtaudio_sdr rtaudio_sink rtlsdr_sdr rtltcp scripting sddc_sdr sdrplay_sdr sdrpp_server soapy_sdr spacex spyserver standard_cpp_compos stereo tubsat umka usrp_sdr wsf"
...
src_configure() {
	local mycmakeargs=(
		...
		-DPLUGIN_AWS=$(usex satdump_plugins_aws ON OFF)
		...
		-DPLUGIN_METEOSAT=$(usex satdump_plugins_meteosat ON OFF)
